...
public class Request {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) { // success
                ...
                if (dataArray.length() > 0) {
                    ...
                    g.getTextChannelById(channelId).sendMessageEmbeds(embed).addActionRow(Button.link("https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExMXF1a3B6cjdmeThiMDJhZWpzYjFtMmxsMnY1Z3Z4YW56M2xlajRrYSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/ztisqLhP99tVSHG136/giphy.gif", "Watch on Luna anime")).queue();
                } else {
                    System.out.println("No data available in the response.");
                }
            } else {
    ...
    public void searchAnime(String title) {
        try {
            URL url = new URL("https://oblivion.wtf/api/animes/search?query=" + title);
        } catch (Exception e) {
